        ...
        <>
          <div className="categoryTitle31">
            ...
            <div className="iconsProfile">
              <div className="imagePlus4" title="Upload product" onClick={() => navigate('/uploadProduct')} />
              <div className="imageCuore4" title="My favorites" onClick={() => navigate('/favorites')} />
            </div>
          </div>
          ...
          <div className="categoryProducts21">
